...
const redDarker = Color(0XFFC51E2C);
const gazOrange = Color(0XFFFF9B37);
...
const kShopBackgroundGradient = LinearGradient(
    ...
    colors: [Color(0xFF666666), Colors.white, Color(0xFF666666)]);
const kShopForegroundGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xB3000000), Color(0x1A000000), Color(0xB3000000)]);
const kShopForegroundGradient1 = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [
      Color(0x1A000000),
...
const catForeGradient = LinearGradient(

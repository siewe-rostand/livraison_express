      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              IconButton(
                            ...
                            content: SelectedFavAddress(
                              ...
                              onTap: (s) {
                                ...
                                setState(() {
                                  ...
                                  widget.addressReceiver.longitude =
                                      s.longitude;
                  ...
                  icon: SvgPicture.asset(AssetManager.addressIcon))
            ],
          ),
          TextFormField(
          ...
          TextFormField(
            autovalidateMode: AutovalidateMode.onUserInteraction,
            decoration:
                const InputDecoration(labelText: 'Description du lieu '),
          ...
          MapTextField(
            address: widget.addressReceiver,
            ...
            onChanged: (value) {
              setState(() {
                ...
                if (isChecked == true) {
                  ...
                  widget.addressReceiver.titre = titleTextController.text;
                }
              });
            },

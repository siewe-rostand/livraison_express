...
class Clients{
  final String? id;
  @JsonKey(name: ClientConstant.fullName)
  final String? fullName;
  final String? name;
  final String? surname;
  final String? email;
  final String? telephone;
  @JsonKey(name: ClientConstant.telephoneAlt)
  final String? telephoneAlt;
  @JsonKey(name: ClientConstant.noteIterne)
  final String? noteInterne;
  @JsonKey(ignore: true)
  final String? providerId;
  @JsonKey(ignore: true)
  final String? providerName;
  @JsonKey(name: ClientConstant.addresses)
